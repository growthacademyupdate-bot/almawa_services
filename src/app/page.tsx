...
const WHY = [
  {
    ...
    text: "We start with your business goals, not a template.",
  },
  {
    icon: HiOutlineChartBar,
    title: "Investor-Grade Work",
    text: "Decks, models and profiles built to the standards VCs expect.",
  },
  {
    icon: HiOutlineShieldCheck,
    title: "Compliance Covered",
    text: "MCA, GST, ISO, FSSAI - all under one accountable team.",
  },
  {
    icon: HiOutlineGlobeAlt,
    title: "Pan India Reach",
    text: "500+ businesses served across every major state.",
  },
];
...
const TIMELINE = [
  {
    ...
    text: "Started as a two-person incorporation desk.",
  },
  {
    year: "2019",
    title: "First 100 clients",
    text: "Expanded into certifications and MSME schemes.",
  },
  {
    year: "2021",
    title: "Fund raising practice",
    text: "Placed our first cohort of startups with angels & VCs.",
  },
  {
    year: "2023",
    title: "Growth studio launched",
    text: "In-house digital marketing and brand studio.",
  },
  {
    year: "2025",
    title: "500+ clients pan India",
    text: "Serving startups and MSMEs across 20+ states.",
  },
];
  ...
  return (
    <>
        ...
        <div className="mt-14 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((s, i) => (
            ...
            >
              ...
              >
                <div
                  className={`h-40 bg-gradient-to-br ${s.color} relative`}
                >
            ...
            {TIMELINE.map((t, i) => (
              ...
              >
                ...
                >
                  ...
                  >
                    <div className="text-primary-glow font-bold text-sm">
                      {t.year}
                    </div>

                    <h4 className="mt-1 text-xl font-display font-bold">
                      {t.title}
                    </h4>

                    <p className="mt-2 text-navy-foreground/70 text-sm">
                      {t.text}
                    </p>
                  </div>

                  <div className="absolute left-4 sm:left-1/2 top-1 -translate-x-1/2 h-4 w-4 rounded-full gradient-primary ring-4 ring-navy" />
                </div>
              </Reveal>
            ))}
          </div>
      ...
      <Section>
        <SectionHeader
          eyebrow="Insights"
          title="Latest from the Almawa journal"
        />
